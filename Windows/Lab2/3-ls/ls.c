...
static void ListFiles(TCHAR *path, BOOL bRecursive, BOOL bAll)
{
	...
	DIE(hFind == INVALID_HANDLE_VALUE, "find first value");
	/* TODO 1 - List all the files in the directory */
	do {
		if (ffd.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY /* TODO 1 - Test if file is directory */) {
